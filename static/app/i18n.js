...
const translations = {
    'zh-CN': {
        ...
        'oauth.codex.oauth': 'OAuth 授权',
        'oauth.codex.oauthDesc': '通过 OpenAI 账号进行标准 OAuth 授权',
        'oauth.codex.batchImport': '批量导入 Codex 凭据',
        'oauth.codex.batchImportDesc': '粘贴 JSON 或上传文件批量导入凭据',
        'oauth.codex.importInstructions': '支持粘贴 JSON 数组或上传多个 .json 凭据文件。每个凭据需包含 access_token、refresh_token、id_token、account_id、email 等必需字段。',
        ...
        'oauth.codex.noCredentials': '请输入有效的凭据数据',
        ...
        'oauth.codex.duplicateCredential': '重复凭据',
        ...
        'modal.provider.batchSelect': '批量选择',
        'modal.provider.selectAll': '全选',
        'modal.provider.batchDelete': '批量删除',
        'modal.provider.batchDeleteConfirm': '确定要删除选中的 {count} 个节点吗？此操作不可恢复。',
        'modal.provider.batchDelete.noSelection': '请先选择要删除的节点',
        'modal.provider.batchDelete.deleting': '正在批量删除...',
        'modal.provider.batchDelete.success': '已批量删除 {count} 个节点',
        'modal.provider.batchDelete.failed': '批量删除失败',
        ...
        'usage.filter.providerType': '查询类型',
        'usage.filter.nodes': '选择节点',
        'usage.filter.allTypes': '全部类型',
        'usage.filter.selectAll': '全选',
        'usage.filter.deselectAll': '取消全选',
        'usage.filter.query': '查询',
        'usage.filter.noNodesSelected': '请先选择要查询的节点',
        'usage.filter.querying': '正在查询 {count} 个节点的用量...',
        'usage.filter.querySuccess': '查询完成: {success}/{total} 成功',
        ...
        // 自动售后
        'config.afterSale.title': '自动售后配置',
        'config.afterSale.enabled': '启用自动售后',
        'config.afterSale.shopBaseUrl': '商城地址',
        'config.afterSale.shopEmail': '商城邮箱',
        'config.afterSale.shopPassword': '商城密码',
        'config.afterSale.region': '全局 Region 覆盖',
        'config.afterSale.interval': '常规扫描间隔(ms)',
        'config.afterSale.urgentInterval': '紧急换号间隔(ms)',
        'config.afterSale.maxRetries': '最大紧急重试次数',
        'provider.badge.afterSale': '售后',
        'provider.badge.afterSaleExpired': '已过期',
        'provider.checkBan': '封号检测',
        'provider.replaceBanned': '换号',
        'provider.afterSaleExpiredTooltip': '自动换号已达最大重试次数',
        'provider.replaceExhausted': '换号失败',
        'provider.resetExpired': '重试换号',
        'provider.resetExpiredTooltip': '重置状态，重新尝试自动换号',
        'provider.resetExpired.success': '已重置，将重新尝试换号',
        'provider.resetExpired.failed': '重置失败',
        'provider.banCheck.notBanned': '账号正常，未被封禁',
        'provider.banCheck.banned': '账号已被封禁，建议执行换号',
        'provider.banCheck.notFound': '未在检测结果中找到当前账号',
        'provider.banCheck.failed': '封号检测失败',
        'provider.replaceConfirm': '确认要为此节点执行换号操作？换号后旧节点将被禁用。',
        'provider.replace.success': '换号成功，新账号已导入',
        'provider.replace.inProgress': '该节点正在换号中，请稍后再试',
        'provider.replace.failed': '换号失败，请稍后重试',
        'provider.networkError': '网络异常，请检查连接后重试',
        'afterSale.import.title': '自动售后 AWS 导入',
        'afterSale.import.tabManual': '手动填写',
        'afterSale.import.tabJson': 'JSON 粘贴',
        'afterSale.import.orderId': '订单 ID',
        'afterSale.import.accountInfo': '账号（名称-密码）',
        'afterSale.import.accountSelect': '选择账号',
        'afterSale.import.accountJson': 'Account JSON',
        'afterSale.import.clientId': 'Client ID',
        'afterSale.import.clientSecret': 'Client Secret',
        'afterSale.import.refreshToken': 'Refresh Token',
        'afterSale.import.region': 'Region',
        'afterSale.import.startUrl': 'Start URL',
        'afterSale.import.submit': '导入',
        'afterSale.import.cancel': '取消',
        'afterSale.import.success': '自动售后账号导入成功',
        'afterSale.import.jsonValid': '✓ 已识别 clientId/clientSecret/refreshToken',
        'afterSale.import.jsonInvalid': 'JSON 格式错误，需包含 clientId、clientSecret、refreshToken',
        'afterSale.replace.success': '自动售后换号成功（订单 {orderId}）',
        'afterSale.import.button': '售后导入',
        'afterSale.import.loading': '正在获取账号列表...',
        'afterSale.import.allImported': '该订单所有账号已导入',
        'afterSale.import.fetchFailed': '无法获取账号列表，请手动输入',
        'afterSale.import.duplicateError': '该账号已导入，请勿重复导入',
        'afterSale.import.noAccounts': '该订单无可用账号',
        'afterSale.import.imported': '已导入',
    },
    'en-US': {
        // Header
        ...
        'oauth.codex.selectMethod': 'Select Auth Method',
        'oauth.codex.oauth': 'OAuth Authorization',
        'oauth.codex.oauthDesc': 'Standard OAuth via OpenAI account',
        'oauth.codex.batchImport': 'Batch Import Codex Credentials',
        'oauth.codex.batchImportDesc': 'Import credentials by pasting JSON or uploading files',
        'oauth.codex.importInstructions': 'Paste a JSON array or upload multiple .json credential files. Each credential must include access_token, refresh_token, id_token, account_id, email and other required fields.',
        'oauth.codex.jsonLabel': 'Credential Data (JSON)',
        'oauth.codex.jsonPlaceholder': 'Paste JSON array containing Codex credentials...',
        'oauth.codex.fileLabel': 'Or upload JSON files',
        'oauth.codex.jsonExample': 'View JSON format example',
        'oauth.codex.credentialCount': 'Credential Count',
        ...
        'oauth.codex.noCredentials': 'Please enter valid credential data',
        'oauth.codex.importSuccess': 'Successfully imported {count} credential(s)',
        'oauth.codex.importAllFailed': 'All {count} credential(s) failed to import',
        'oauth.codex.importPartial': 'Partial success: {success} imported, {failed} failed',
        'oauth.codex.importError': 'Error during import',
        'oauth.codex.duplicateCredential': 'Duplicate credential',
        ...
        'modal.provider.batchSelect': 'Batch Select',
        'modal.provider.selectAll': 'Select All',
        'modal.provider.batchDelete': 'Batch Delete',
        'modal.provider.batchDeleteConfirm': 'Delete {count} selected node(s)? This cannot be undone.',
        'modal.provider.batchDelete.noSelection': 'Please select nodes to delete first',
        'modal.provider.batchDelete.deleting': 'Batch deleting...',
        'modal.provider.batchDelete.success': 'Batch deleted {count} node(s)',
        'modal.provider.batchDelete.failed': 'Batch delete failed',
        ...
        'usage.filter.providerType': 'Provider Type',
        'usage.filter.nodes': 'Select Nodes',
        'usage.filter.allTypes': 'All Types',
        'usage.filter.selectAll': 'Select All',
        'usage.filter.deselectAll': 'Deselect All',
        'usage.filter.query': 'Query',
        'usage.filter.noNodesSelected': 'Please select nodes to query first',
        'usage.filter.querying': 'Querying usage for {count} node(s)...',
        'usage.filter.querySuccess': 'Query complete: {success}/{total} succeeded',
        ...
        // Auto After-Sale
        'config.afterSale.title': 'Auto After-Sale',
        'config.afterSale.enabled': 'Enable Auto After-Sale',
        'config.afterSale.shopBaseUrl': 'Shop Base URL',
        'config.afterSale.shopEmail': 'Shop Email',
        'config.afterSale.shopPassword': 'Shop Password',
        'config.afterSale.region': 'Global Region Override',
        'config.afterSale.interval': 'Scan Interval (ms)',
        'config.afterSale.urgentInterval': 'Urgent Replace Interval (ms)',
        'config.afterSale.maxRetries': 'Max Urgent Retries',
        'provider.badge.afterSale': 'After-Sale',
        'provider.badge.afterSaleExpired': 'Expired',
        'provider.checkBan': 'Check Ban',
        'provider.replaceBanned': 'Replace',
        'provider.afterSaleExpiredTooltip': 'Auto-replace reached max retries',
        'provider.replaceExhausted': 'Replace Failed',
        'provider.resetExpired': 'Retry Replace',
        'provider.resetExpiredTooltip': 'Reset status and retry auto-replace',
        'provider.resetExpired.success': 'Reset, will retry auto-replace',
        'provider.resetExpired.failed': 'Reset failed',
        'provider.banCheck.notBanned': 'Account is active, not banned',
        'provider.banCheck.banned': 'Account is banned, consider replacing',
        'provider.banCheck.notFound': 'Current account not found in results',
        'provider.banCheck.failed': 'Ban check failed',
        'provider.replaceConfirm': 'Replace this account? The old node will be disabled.',
        'provider.replace.success': 'Replacement successful, new account imported',
        'provider.replace.inProgress': 'Replacement in progress, please wait',
        'provider.replace.failed': 'Replacement failed, please retry later',
        'provider.networkError': 'Network error, please check connection',
        'afterSale.import.title': 'Auto After-Sale AWS Import',
        'afterSale.import.tabManual': 'Manual',
        'afterSale.import.tabJson': 'JSON Paste',
        'afterSale.import.orderId': 'Order ID',
        'afterSale.import.accountInfo': 'Account (name-password)',
        'afterSale.import.accountSelect': 'Select Account',
        'afterSale.import.accountJson': 'Account JSON',
        'afterSale.import.clientId': 'Client ID',
        'afterSale.import.clientSecret': 'Client Secret',
        'afterSale.import.refreshToken': 'Refresh Token',
        'afterSale.import.region': 'Region',
        'afterSale.import.startUrl': 'Start URL',
        'afterSale.import.submit': 'Import',
        'afterSale.import.cancel': 'Cancel',
        'afterSale.import.success': 'After-sale account imported successfully',
        'afterSale.import.jsonValid': '✓ Recognized clientId/clientSecret/refreshToken',
        'afterSale.import.jsonInvalid': 'Invalid JSON, must contain clientId, clientSecret, refreshToken',
        'afterSale.replace.success': 'Auto after-sale replacement success (Order {orderId})',
        'afterSale.import.button': 'After-Sale Import',
        'afterSale.import.loading': 'Fetching account list...',
        'afterSale.import.allImported': 'All accounts in this order have been imported',
        'afterSale.import.fetchFailed': 'Failed to fetch account list, please enter manually',
        'afterSale.import.duplicateError': 'This account has already been imported',
        'afterSale.import.noAccounts': 'No available accounts in this order',
        'afterSale.import.imported': 'imported',
    }
};
